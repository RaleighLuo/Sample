...
public class ZoomHeaderActivity extends AppCompatActivity {
  ...
  class Adapter extends PagerAdapter {
    public Adapter() {
      views = new ArrayList<>();
      views.add(View.inflate(ZoomHeaderActivity.this, R.layout.item_img, null));
      views.get(0).findViewById(R.id.btn_buy).setOnClickListener(new View.OnClickListener() {
        @Override public void onClick(View v) {
          Toast.makeText(ZoomHeaderActivity.this, "buy", Toast.LENGTH_SHORT).show();
        }
      });
      views.add(View.inflate(ZoomHeaderActivity.this, R.layout.item_img, null));
