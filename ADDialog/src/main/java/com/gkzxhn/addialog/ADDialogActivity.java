...
import com.gkzxhn.addialog.bean.AdInfo;
import com.gkzxhn.addialog.transformer.DepthPageTransformer;
import com.gkzxhn.addialog.transformer.RotateDownPageTransformer;
    ...
    private void initListener() {
        ...
        spinner.setOnItemSelectedListener(new AdapterView.OnItemSelectedListener() {
            ...
            public void onItemSelected(AdapterView<?> parent, View view, int position, long id) {
                AdManager adManager = new AdManager(ADDialogActivity.this, advList);
        ...
        button1.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if (TextUtils.isEmpty(result)) {
                    Toast.makeText(ADDialogActivity.this, "请输入弹出动画的角度!", Toast.LENGTH_SHORT).show();
                    return;
                }
                ...
                adManager.setOnImageClickListener(new AdManager.OnImageClickListener() {
                    ...
                    public void onImageClick(View view, AdInfo advInfo) {
                        Toast.makeText(ADDialogActivity.this, "您点击了ViewPagerItem...", Toast.LENGTH_SHORT).show();
                    }
                });
