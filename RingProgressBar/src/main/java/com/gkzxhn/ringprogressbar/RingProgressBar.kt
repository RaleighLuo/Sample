...
class RingProgressBar @JvmOverloads constructor(context: Context, attrs: AttributeSet? = null, defStyle: Int = 0) : View(context, attrs, defStyle) {
    ...
    private fun drawProgress(canvas: Canvas) {
        ...
        //FIll样式
        val fillOval = RectF((centre - radius).toFloat() + ringWidth + padding,
                (centre - radius).toFloat() + ringWidth + padding, (centre + radius).toFloat() - ringWidth - padding,
                (centre + radius).toFloat() - ringWidth - padding)
